...
public class LocationPopupPage extends BasicPage{
	...
	public WebElement getLocationBtn() {
		 WebElement locationButton = this.driver.findElement(By.className("location-selector")).findElement(By.tagName("a"));
	...
	public void LocationForm2() {
		this.driver.findElement(By.className("close-btn-white")).click();
	}
